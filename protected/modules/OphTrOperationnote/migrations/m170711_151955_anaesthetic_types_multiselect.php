...
class m170711_151955_anaesthetic_types_multiselect extends OEMigration
{
    public function safeUp()
    {
        ...
        $this->insert('anaesthetic_type', array(
            'name' => 'Sedation','code' => 'Sed', 'created_user_id' => 1, 'active' => 1, 'last_modified_user_id' => 1, 'display_order' => 1));
        $this->insert('anaesthetic_type', array(
            'name' => 'No Anaesthetic', 'code' => 'NoA', 'created_user_id' => 1, 'active' => 1, 'last_modified_user_id' => 1, 'display_order' => 1));
